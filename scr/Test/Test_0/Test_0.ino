...
//  myMPU9250.autoOffsets();
  ...
  myMPU6050.setAccelerometerRange(MPU6050_RANGE_16_G);
  myMPU6050.setGyroRange(MPU6050_RANGE_2000_DEG);
  myMPU6050.setFilterBandwidth(MPU6050_BAND_260_HZ);
...
void loop() {
  ...
  ans+=String(g.gyro.x)+sep;ans+=String(micros())+sep;
  ans+=String(g.gyro.y)+sep;ans+=String(micros())+sep;
  ans+=String(g.gyro.z)+sep;ans+=String(micros())+sep;
  ans+=String(a.acceleration.x)+sep;ans+=String(micros())+sep;
  ans+=String(a.acceleration.y)+sep;ans+=String(micros())+sep;
  ans+=String(a.acceleration.z)+sep;ans+=String(micros())+sep;
  ans+=String(a.acceleration.x + a.acceleration.y + a.acceleration.z )+sep;ans+=String(micros())+sep;
